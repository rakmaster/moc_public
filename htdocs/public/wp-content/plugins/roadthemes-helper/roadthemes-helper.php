...
function road_skill_shortcode( $atts ) {
	...
	$html.= '<div class="percent_text"><span class="bg"></span><span class="text">'.$atts['percent'].'%</span></div>';
	$html.= '<div class="percent"><div class="percent_color" style="width: '.$atts['percent'].'%;">'.$atts['title'].'</div></div>';
	$html.= '</div>';
				...
				$html.='<div class="item-col">';
					$html.='<div class="post-wrapper">';
						$html.='<div class="post-thumb">';
							$html.='<a href="'.get_the_permalink($post->ID).'">'.get_the_post_thumbnail($post->ID, $imagesize).'<span class="moretag"><span>'.esc_html($road_opt['readmore_text']).'</span></span><span class="post_date"><span class="day">'.get_the_date('d', $post->ID).'</span><span class="month">'.get_the_date('M', $post->ID).'</span></span></a>';
						$html.='</div>';
						$html.='<div class="post-info">';
							...
							$html.='<div class="post-meta">';
								...
								$html.='<span class="entry-date"><i class="fa fa-calendar"></i>'.get_the_date('Y-m-d', $post->ID).'&nbsp;/&nbsp;'.get_the_time('H:i:s', $post->ID).'</span>';
								$html.='<span class="entry-comment"><i class="fa fa-comment-o"></i>'. $write_comments.'</span>';
							$html.='</div>';
