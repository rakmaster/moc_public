	...
	public function admin_enqueue_scripts ( $hook = '' ) {
		...
		switch ($screen) {
			...
			default:
				...
				if( !class_exists('acf') ){
			        wp_register_script( 'google_map', '//maps.google.com/maps/api/js?sensor=true');
		...
		wp_enqueue_script( $this->_token . '-admin', esc_url( $this->assets_url ) . 'js/admin' . $this->script_suffix . '.js', $scripts, $this->_version, true );
