            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
					...
					array(
                        'id'        => 'logo_erorr',
                        'type'      => 'media',
                        'title'     => __('Logo 404', 'redux-framework'),
                        'compiler'  => 'true',
                        'mode'      => false,
                        'desc'      => __('Upload logo 404 here.', 'redux-framework'),
                    ),
					array(
                        'id'        => 'opt-favicon',
                        'type'      => 'media',
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
					array(
                        ...
                        'subtitle'  => __('Pick a color for primary color (default: #1abc9c).', 'redux-framework'),
						'transparent' => false,
                        'default'   => '#1abc9c',
                        'validate'  => 'color',
                    ),
					...
					array(
                        ...
                        'subtitle'  => __('Pick a color for bg sale label (default: #e23a3b).', 'redux-framework'),
						'transparent' => false,
                        'default'   => '#e23a3b',
                        'validate'  => 'color',
                    ),
					...
					array(
                        ...
                        'subtitle'  => __('Pick a color for star of rating (default: #1abc9c).', 'redux-framework'),
						'transparent' => false,
                        'default'   => '#1abc9c',
                        'validate'  => 'color',
                    ),
			...
			$this->sections[] = array(
                ...
                'fields'    => array(
					...
					array(
                        'id'        => 'footer_skin',
                        'type'      => 'select',
                        'title'     => __('Footer Skin', 'redux-framework'),
                        'customizer_only'   => true,
					...
					array(
						...
						'subtitle'         => __('HTML tags allowed: a, br, em, img, strong', 'redux-framework'),
						'default'          => '',
						'args'   => array(
							'teeny'            => true,
							'textarea_rows'    => 10
					...
					array(
                        ...
                        'type'      => 'text',
                        'title'     => __('Testimonials title', 'redux-framework'),
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
					...
					array(
						...
						'default'          => '<strong>RoadThemes</strong>1234 Pall Mall, London, England',
						'args'   => array(
							'teeny'            => true,
							'textarea_rows'    => 5,
							'media_buttons'	=> false,
