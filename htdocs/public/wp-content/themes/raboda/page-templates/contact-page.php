...
<div class="main-container contact-wrapper with-sidebar">
	...
	<div class="contact-fom-info">
		<div class="container">
			<div class="row">
				<?php if($road_opt['sidebarcontact_pos']=='left') :?>
					<?php get_sidebar('contact'); ?>
				<?php endif; ?>
				<div class="col-xs-12 <?php if ( is_active_sidebar( 'sidebar-contact' ) ) : ?>col-md-7<?php endif; ?>">
				...
				<?php if($road_opt['sidebarcontact_pos']=='right') :?>
					<?php get_sidebar('contact'); ?>
				<?php endif; ?>
			</div>
